...
namespace Producto_2 {
    ...
    public partial class HotelSQLDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuarioRow AddUsuarioRow(string nombre, string password) {
...
namespace Producto_2.HotelSQLDataSetTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuario] WHERE (([nombre] = @Original_nombre) AND ([ID] = @Ori" +
                "ginal_ID) AND ([password] = @Original_password))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([nombre], [password]) VALUES (@nombre, @password);\r\n" +
                "SELECT nombre, ID, password FROM Usuario WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuario] SET [nombre] = @nombre, [password] = @password WHERE (([no" +
                "mbre] = @Original_nombre) AND ([ID] = @Original_ID) AND ([password] = @Original_" +
                "password));\r\nSELECT nombre, ID, password FROM Usuario WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT nombre, ID, password FROM dbo.Usuario";
        ...
        public virtual int Fill(HotelSQLDataSet.UsuarioDataTable dataTable) {
        ...
        public virtual HotelSQLDataSet.UsuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HotelSQLDataSet.UsuarioDataTable dataTable = new HotelSQLDataSet.UsuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HotelSQLDataSet.UsuarioDataTable dataTable) {
        ...
        public virtual int Delete(string Original_nombre, int Original_ID, string Original_password) {
        ...
        public virtual int Update(string nombre, string password, string Original_nombre, int Original_ID, string Original_password, int ID) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string password, string Original_nombre, int Original_ID, string Original_password) {
            return this.Update(nombre, password, Original_nombre, Original_ID, Original_password, Original_ID);
        }
    }
